...
const COPY_BTN = `<button class="btn-icon btn-copy">
                    ...
                    <img src="/assets/icons/fa/copy.svg" alt="copy icon">
                 </button>`
...
function highlight(str, lang, info) {
  ...
  let codeHeader = filename
    ? `<div class="code-header"><b>file:</b> ${filename.val}</div>`
    : title
    ? `<div class="code-header">${title.val}</div>`
    : ""
