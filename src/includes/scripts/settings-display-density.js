...
var displayDensitySetting =
  localStorage.getItem("settings-display-density") || "card"
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var displayEl = document.querySelector(
    "input[type='radio'][name='display-toggle'][value='" +
      displayDensitySetting +
      "']"
  )
  if (displayEl) {
  ...
  document
    .querySelectorAll("input[type='radio'][name='display-toggle']")
    .forEach(function (el) {
