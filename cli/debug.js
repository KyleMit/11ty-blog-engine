...
async function main() {
  try {
    ...
    // TODO check package.json to see if crb exists
    await utils.cmd(`npm install create-eleventy-blog`)

    // todo - do we need a check before proceeding?
    // [node.js - Easy way to list node modules I have npm linked? - Stack Overflow](https://stackoverflow.com/questions/24933955/easy-way-to-list-node-modules-i-have-npm-linked)
    // [symlinked/index.js at master · ryanve/symlinked](https://github.com/ryanve/symlinked/blob/master/index.js)
    await utils.cmd(`npm link create-eleventy-blog`)
